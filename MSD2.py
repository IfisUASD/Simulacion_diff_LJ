...
def MSDD(xyz,particulas,stepF,step):
    l = 0 # contador
    t = (stepF-step)/step
    x0,y0,z0 = filtxyz("Timestep0","x"), filtxyz("Timestep0","y"), filtxyz("Timestep0","z")
    #print(len(x0))
    xf,yf,zf = filtxyz("Timestep{}".format(stepF-step),"x"),filtxyz("Timestep{}".format(stepF-step),"y"),\
    filtxyz("Timestep{}".format(stepF-step),"z") 
    #print(len(xf))
